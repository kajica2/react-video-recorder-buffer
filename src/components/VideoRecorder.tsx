 ...
 *
 * Provides video recording functionality with real-time preview,
 * buffer management, and progressive upload to Supabase.
 */
...
export const VideoRecorder: React.FC<VideoRecorderProps> = ({
  ...
  const startRecording = useCallback(async (): Promise<void> => {
    if (!user) {
      handleError('Please sign in to record videos');
      return;
    }
